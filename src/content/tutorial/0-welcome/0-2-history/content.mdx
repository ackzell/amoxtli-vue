...
<YouTubeLink 
  ...
  description="This talk will be a high-level introduction to the Vue framework, covering its origin, architecture, design philosophy, ecosystem and (some) comparison with other mainstream frameworks. 
"
  duration="25 min"
/>
...
<iframe 
  width="560" 
  height="315" 
  src="https://www.youtube.com/embed/p2P3z7p_zTI" 
