...
Very quickly: Vue implements a dependency-tracking based <AvTooltipTrigger id="reactivity">reactivity</AvTooltipTrigger> system.
...
<AvTooltipContent id="reactivity">
:::info
